...
- **Migrationer:** numrerad kedja i `server/migrations/` (`NNNN_snake_case.sql`, just nu 0001–0071), kors idempotent med `npm run migrate` som agarrollen (`DATABASE_ADMIN_URL`); appen ansluter som icke-superuser `app` sa RLS tvingas.
