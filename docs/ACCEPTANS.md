...
**Reproducera allt:** `npm test -w server` → **448 tester passerar** i 61 sviter mot
...
| # | Kriterium | Status | Bevis |
|---|---|---|---|
| L.1 | Enhetstester på kärnlogiken körs i **CI**, grönt med testantal > 0 | ✅ | `.github/workflows/ci.yml` (typecheck + build + 448 tester) |
