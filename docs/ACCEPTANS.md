...
**Reproducera allt:** `npm test -w server` → **454 tester passerar** i 62 sviter mot
...
| # | Kriterium | Status | Bevis |
|---|---|---|---|
| L.1 | Enhetstester på kärnlogiken körs i **CI**, grönt med testantal > 0 | ✅ | `.github/workflows/ci.yml` (typecheck + build + 454 tester) |
